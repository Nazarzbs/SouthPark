//
//  SPLocationEpisodesDetailCellViewModel.swift
//  SouthPark
//
...
import Foundation
import UIKit
//The required properties for location data rendering.
//Define the signature of what data we need (kind of masking other properties)
protocol SPLocationDetailEpisodeDataRender {
    var name: String { get }
    var episode: Int { get }
    var season: Int { get }
...
final class SPLocationEpisodesDetailCellViewModel: Hashable, Equatable {
    ...
    private var dataBlock: ((SPLocationDetailEpisodeDataRender, Data?) -> Void)?
    ...
    public func registerForData(_ block: @escaping (SPLocationDetailEpisodeDataRender, Data?) -> Void) {
    ...
    static func == (lhs: SPLocationEpisodesDetailCellViewModel, rhs: SPLocationEpisodesDetailCellViewModel) -> Bool {
