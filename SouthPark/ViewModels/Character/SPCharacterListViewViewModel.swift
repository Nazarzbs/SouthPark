    ...
    private var characters: [SPCharacter] = [] {
        didSet {
            ...
            for character in characters {
                ...
                let viewModel = SPCharacterCollectionViewCellViewModel(characterName: character.name, characterOccupation: character.occupation ?? "Not given", characterImageName: character.name, id: character.id)
